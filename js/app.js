...
* Copyright (c) 2016 Thomas Grainger; Licensed MIT */            !function(a, b) {
                ...
                var l, m, n = function() {
                    ...
                    return n(a, [ {
                        ...
                        value: function(a) {
                            ...
                            null != this.config.callback && this.config.callback(a), h(a, this.wowEvent), i(a, "animationend", this.resetAnimation), 
    ...
    (() => {
        ...
        var wow_min = __webpack_require__(135);
        window.addEventListener("load", (() => {
            const config = new wow_min({
                boxClass: "anim",
